...
namespace NetworkLib.Utils
{
    public class NetPacketProcessor
    {
        ...
        private readonly Message _netDataWriter = new Message();
        ...
        protected virtual void WriteHash(Type type, Message writer)
        {
            writer.Add(GetHash(type));
        }
        ...
        public void Send<T>(Player peer, T packet, DeliveryMethod options) where T : class, new()
        {
        ...
        public void SendNetSerializable<T>(Player peer, T packet, DeliveryMethod options) where T : INetSerializable
        {
            _netDataWriter.Reset();
        ...
        public void Send<T>(EZMultiplayer manager, T packet, DeliveryMethod options) where T : class, new()
        {
            _netDataWriter.Reset();
            Write(_netDataWriter, packet);
        ...
        public void SendNetSerializable<T>(EZMultiplayer manager, T packet, DeliveryMethod options) where T : INetSerializable
        {
            _netDataWriter.Reset();
            WriteNetSerializable(_netDataWriter, packet);
            manager.SendToAll(_netDataWriter, options);
        ...
        public void WriteNetSerializable<T>(Message writer, T packet) where T : INetSerializable
        {
            WriteHash(typeof(T), writer);
