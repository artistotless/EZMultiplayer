...
namespace NetworkLib
{
    ...
    public sealed class Player
    {
        ...
        private readonly EZMultiplayer _netManager;
        private readonly NetPacketPool _packetPool;
        private readonly object _flushLock = new object();
        private readonly object _sendLock = new object();

        internal Player NextPeer;
        internal Player PrevPeer;
        ...
        /// <summary>
        /// Player parent EZMultiplayer
        /// </summary>
        public EZMultiplayer NetManager { get { return _netManager; } }
        ...
        internal Player(EZMultiplayer netManager, IPEndPoint remoteEndPoint)
        {
        ...
        {
            this.name = "Player#" + new Random().Next(1000000);
        ...
        internal Player(EZMultiplayer netManager, IPEndPoint remoteEndPoint, byte connectNum, Message connectData) : this(netManager, remoteEndPoint)
        {
            Initialize();
        ...
        {
            return _currentRoom == null ? false : true;
        }
        internal Room CurrentRoom()
        {
            return _currentRoom != null ? _currentRoom : null;
        }
        ...
        ///     Fragment count exceeded ushort.MaxValue<para/>
        /// </exception>
        public void Send(Message dataWriter, DeliveryMethod options)
        {
        ...
        public void Disconnect(Message writer)
        {
