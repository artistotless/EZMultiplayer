...
namespace NetworkLib
{
    ...
    /// <summary>
    /// Module for UDP NAT Hole punching operations. Can be accessed from EZMultiplayer
    /// </summary>
    public sealed class NatPunchModule
    {
            ...
            string additionalInfo)
        {
            ...
            //First packet (server)
            //send to client
            dw.Add((byte)PacketProperty.NatIntroduction);
            dw.Add(ClientByte);
            dw.Add(hostInternal);
            dw.Add(hostExternal);
            dw.Add(additionalInfo, MaxTokenLength);
            int errorCode = 0;
            ...
            dw.Add((byte)PacketProperty.NatIntroduction);
            dw.Add(HostByte);
            dw.Add(clientInternal);
            dw.Add(clientExternal);
            dw.Add(additionalInfo, MaxTokenLength);
        ...
        public void SendNatIntroduceRequest(IPEndPoint masterServerEndPoint, string additionalInfo)
        {
            ...
            dw.Add((byte)PacketProperty.NatIntroductionRequest);
            dw.Add(localEndPoint);
            dw.Add(additionalInfo, MaxTokenLength);
        ...
        private void HandleNatIntroduction(NetDataReader dr)
        {
            ...
            Message writer = new Message();

            // send internal punch
            writer.Add((byte)PacketProperty.NatPunchMessage);
            writer.Add(hostByte);
            writer.Add(token);
            int errorCode = 0;
