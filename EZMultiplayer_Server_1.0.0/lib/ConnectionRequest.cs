...
namespace NetworkLib
{
    ...
    {
        private readonly EZMultiplayer.ConnectionSolved _onUserAction;
        private int _used;
        ...
        internal ConnectionRequest(
            ...
            Player peer,
            EZMultiplayer.ConnectionSolved onUserAction)
        {
        ...
        public Player AcceptIfKey(string key)
        {
            if (!TryActivate())
                return null;
            try
        ...
        public void Reject(Message rejectData)
        {
