...
namespace LiteNetLib
{
    ...
    /// </summary>
    public sealed class NetManager : IEnumerable<Player>
    {
        ...
        public Player Connect(string address, int port, string key)
        {
        ...
        /// <returns>Null if connections limit reached, New NetPeer if new connection, Old NetPeer if already connected</returns>
        /// <exception cref="InvalidOperationException">Manager is not running. Call <see cref="Start()"/></exception>
        public Player Connect(IPEndPoint target, string key)
        {
        ...
        /// <returns>Null if connections limit reached, New NetPeer if new connection, Old NetPeer if already connected</returns>
        /// <exception cref="InvalidOperationException">Manager is not running. Call <see cref="Start()"/></exception>
        public Player Connect(IPEndPoint target, Message connectionData)
        {
            if (!IsRunning)
