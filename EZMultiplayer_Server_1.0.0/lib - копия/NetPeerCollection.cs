...
namespace LiteNetLib
{
    ...
    {
        private readonly Dictionary<IPEndPoint, Player> _peersDict;
        private readonly ReaderWriterLockSlim _lock;
        public int Count;
        public volatile Player HeadPeer;

        public NetPeerCollection()
        {
            _peersDict = new Dictionary<IPEndPoint, Player>(new IPEndPointComparer());
            _lock = new ReaderWriterLockSlim(LockRecursionPolicy.NoRecursion);
        }

        public bool TryGetValue(IPEndPoint endPoint, out Player peer)
        {
            _lock.EnterReadLock();
        ...
        public bool TryAdd(Player peer)
        {
        ...
        public void RemovePeers(List<Player> peersList)
        {
        ...
        private void RemovePeerInternal(Player peer)
        {
