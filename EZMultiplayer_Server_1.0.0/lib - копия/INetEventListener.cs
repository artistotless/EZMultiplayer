...
namespace LiteNetLib
{
    ...
    public interface INetEventListener
    {
        ...
        /// </summary>
        /// <param name="room">Возвращает объект созданной комнаты</param>
        /// <param name="player">Возвращает объект игрока,создавшего комнату</param>
        void OnUserCreateRoom(Room room, Player player);

        /// <summary>
        /// Вызывается при подключении игрока к комнате
        /// </summary>
        /// <param name="room">Возвращает объект комнаты</param>
        /// <param name="player">Возвращает объект игрока,подключающегося к комнате</param>
